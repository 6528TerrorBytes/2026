...
//Possibly the import needed for the Pigeon
...
{
  //Possibly how you set up the pigeon, unsure
  private final Pigeon2 m_pigeon = new Pigeon2(10);

  public static boolean overrideRotation = false;
  public static double newRotation = 0;
  public double aprilTagRotation = 0;
   ...
   */
  public SwerveSubsystems(File directory)
  {
   ...
   */
  public SwerveSubsystems(SwerveDriveConfiguration driveCfg, SwerveControllerConfiguration controllerCfg)
  {
  ...
  //   return run(() -> {
  //     Optional<PhotonPipelineResult> resultO = camera.getAllUnreadResults();
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  {
    aprilTagRotation = Math.pow(angularRotationX.getAsDouble(), 3) * swerveDrive.getMaximumChassisAngularVelocity();
